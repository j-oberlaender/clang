...
template <> struct MappingTraits<FormatStyle> {
  static void mapping(IO &IO, FormatStyle &Style) {
    ...
    IO.mapOptional("AlignLessLessInsideParens", Style.AlignLessLessInsideParens);
    ...
    IO.mapOptional("BreakChainedParenExpressions", Style.BreakChainedParenExpressions);
    ...
    IO.mapOptional("VariableNames", Style.VariableNames);
...
FormatStyle getLLVMStyle() {
  ...
  LLVMStyle.AlignLessLessInsideParens = true;
  ...
  LLVMStyle.BreakChainedParenExpressions = false;
